...
\begin{center}
        \textbf{DERIVATIONS} 
          \end{center}                                                       \begin{enumerate}                                                                   \item                                                         Derivative of $e^{\sin^2x}$ with respect to $ \cos{x}$ is:                      \begin{enumerate}[label={$\brak{\Alph*}$}]                              \item $\sin{x}e^{\sin^2x}$                                              \item $\cos{x}e^{\sin^2x}$                                              \item $-2{\cos{x}e^{\sin^2x}}$                                          \item $-2{\sin^2{x}\cos{x}e^{\sin^2x}}$ 
                   \end{enumerate}                                                        \item                                                         If $\sin $\brak{xy}$=1$,then $\frac{dy}{dx}$ is equal to:                     \begin{enumerate}[label={$\brak{\Alph*}$}]
