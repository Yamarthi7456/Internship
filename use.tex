...
\begin{enumerate}
	...
	\item Find the matrix $A^2$, where $A$ = $\sbrak{a_{ij}}$ is a        $2 \times 2 $ matrix whose elements are given by $\text a_{ij}$ = \text{maximum}$\brak{i, j}$ - \text{minimum}$\brak{i, j}$ :                            \begin{enumerate}[label={$\brak{\Alph*}$}]
                \item $\myvec{0 & 0 \\ 0 & 0}$
                \item $\myvec{0 & 1 \\ 1 & 0}$
                \item $\myvec{1 & 0 \\ 0 & 1}$
                \item $\myvec{1 & 1 \\ 1 & 1}$
...
\begin{center}
        \textbf{DERIVATIONS} 
          \end{center}                                                       \begin{enumerate}                                                                   \item                                                         [1.]Derivative of $e^{\sin^2x}$ with respect to $ \cos{x}$ is:                      \begin{enumerate}[label={$\brak{\Alph*}$}]                              \item $\sin{x}e^{\sin^2x}$                                              \item $\cos{x}e^{\sin^2x}$                                              \item $-2{\cos{x}e^{\sin^2x}}$                                          \item $-2{\sin^2{x}\cos{x}e^{\sin^2x}}$ 
                   \end{enumerate}                                                        \item                                                         [2.]If $\sin $\brak{xy}$=1$,then $\frac{dy}{dx}$ is equal to:                     \begin{enumerate}[label={$\brak{\Alph*}$}]
                  \item $\frac{x}{y}$                                                     \item $-\frac{x}{y}$
                  \item $\frac{y}{x}$
                  \item $-\frac{y}{x}$
                  \end{enumerate}
                        \item
